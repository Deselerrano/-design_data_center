...
￼
![alt text](https://github.com/Deselerrano/-design_data_center/blob/main/lecuture/99999.png?raw=true)

Но не забываем про цену этого числа
 #### Возможность проведения работ без вреда для сервисов

## 3 - Современная модель построения сетей ЦОД, CLOS
￼
￼
Exit - borderleaf
+ ToR
